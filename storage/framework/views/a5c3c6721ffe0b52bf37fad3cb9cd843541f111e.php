                ...
                <div class="col-md-3 mb-2">
                    <div class="card p-2">
                        <div class="text-center" style="height:150px">
                            <img class="card-img-top w-auto h-100" src="<?php echo e($product->file); ?>" alt="">
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><?php echo e($product->name); ?></h5>
                            <h6 class="card-subtitle mb-2 text-muted "><?php echo e($product->description); ?></h6>
                            <p class="card-text">Categoria:</p>
                            Preço
                        </div>
                        <div class="card-footer text-center">
                            <button data-id='<?php echo e($product->id); ?>' type="button" class="btn btn-danger btn-del"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carlos\Desktop\site\shop-app\resources\views/product/list.blade.php ENDPATH**/ ?>