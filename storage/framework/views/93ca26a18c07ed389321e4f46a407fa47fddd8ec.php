    ...
    <div id="carousel" class="carousel slide" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?php echo e(asset('banners/banner-1.png')); ?>" class="d-block w-100" alt="">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('banners/banner-2.png')); ?>" class="d-block w-100" alt="">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="<?php echo e(asset('banners/banner-3.png')); ?>" class="d-block w-100" alt="">
                <div class="carousel-caption d-none d-md-block">
...
<?php /**PATH C:\Users\Carlos\Desktop\site\shop-app\resources\views/layouts/carousel.blade.php ENDPATH**/ ?>