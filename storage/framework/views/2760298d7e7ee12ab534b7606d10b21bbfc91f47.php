        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '#submit', function() {
                ...
                `);
                                ...
                                function loadTable() {
                                    $('#myTable tbody').html('');
                                    $.getJSON("<?php echo e(url('category/all')); ?>", function(data, textStatus, jqXHR) {
                                        data.forEach(e => {
                                            table.row.add([`
                                ${e.name}`, `
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Carlos\Desktop\site\shop-app\resources\views/category/index.blade.php ENDPATH**/ ?>